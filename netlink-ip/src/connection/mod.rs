...
///
/// use netlink_sys::constants::{NLM_F_REQUEST, NLM_F_DUMP};
/// use netlink_sys::NetlinkFlags;
/// use netlink_sys::rtnl::{RtnlMessage, Message, LinkNla, LinkMessage};
...
///     let mut req = Message::from(RtnlMessage::GetLink(LinkMessage::new()));
...
///             // print it
///             if let (_, RtnlMessage::NewLink(link_msg)) = msg.clone().into_parts() {
