...
pub struct Connection {
    ...
    requests_buffer: VecDeque<Message>,
...
impl Connection {
    ...
    fn send_request(&mut self, message: Message) -> AsyncSink<Message> {
    ...
    fn buffer_request(&mut self, request: Message) -> Result<(), NetlinkIpError> {
